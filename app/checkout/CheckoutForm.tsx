  ...
  return <form action={action} className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_360px]">
    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-slate-200 bg-white p-6">
        <h2 className="flex items-center gap-2 text-xl font-bold"><CalendarDays className="size-5 text-emerald-600" /> Reservation details</h2>
    ...
    <aside className="h-fit rounded-2xl border border-slate-200 bg-white p-6 shadow-lg lg:sticky lg:top-6">
      ...
      <p className="mt-3 flex items-start gap-2 rounded-xl bg-emerald-50 p-3 text-xs text-emerald-800"><CheckCircle2 className="mt-0.5 size-4 shrink-0" />Confirm cancellation terms and payment arrangements with the provider before reserving.</p>
    </aside>
  </form>;
}
