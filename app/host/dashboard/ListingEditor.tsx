  ...
  return <div className="mt-5 border-t border-slate-100 pt-4">
    ...
    <details className="mt-4">
      ...
      <form action={saveAction} className="mt-4 grid gap-4 sm:grid-cols-2">
        ...
        <label className="text-sm font-medium">{definition.priceLabel}<input name="price" type="number" min="0.01" max="1000000" step="0.01" required defaultValue={service.price} className={inputClass} /></label>
